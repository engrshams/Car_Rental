    ...
    <Layout>
        ...
        <main class="ml-64 p-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="/admin/sliders/create" class="bg-blue-500 text-white px-4 py-2 rounded-md">Add Slide</a>
            </div>
                    ...
                    <tbody>
                        <tr class="border-b" v-for="(item, index) in props.slides" :key="index">
                            ...
                            <td class="p-3 space-x-2">
                                <div class="space-x-2">
                                    <Link :href="`/admin/sliders/${item.id}/edit`" class="bg-yellow-500 text-white px-2 py-1 rounded-md">Edit</Link>
                                    <button @click="deleteSlide(item.id)" class="bg-red-500 text-white px-2 py-1 rounded-md">Delete</button>
                                </div>
                            </td>
                        </tr>
